...
export default function createRoutes({ getState, dispatch }) {
  return (
    <Router>
      ...
      {/*<Route path="/login" component={Login} onEnter={doesInitiationed(getState, dispatch)} />*/}
      {/*<Route path="/register" component={Register} onEnter={doesInitiationed(getState, dispatch)} />*/}
      {/*<Route path="/forgotpass" component={ForgotPassword} onEnter={doesInitiationed(getState, dispatch)} />*/}
